...
class BlockList
{
    ...
    public static function getName(string $id): string
    {
        ...
        $BlockList = EpicGroup::$getInstance->BlickList->get($id, NULL);
        if ($BlockList !== NULL) {
            return $BlockList;
        }
        $idx = explode(":", $id);
    ...
    public static function getID(string $Name): string
    {
        ...
        $name = array_search($Name, EpicGroup::$getInstance->getBlickID()->getAll());
        if ($name == NULL) {
            return $Name;
        }
        return $name;
    ...
    public static function makeConfig(EpicGroup $plugin)
    {
